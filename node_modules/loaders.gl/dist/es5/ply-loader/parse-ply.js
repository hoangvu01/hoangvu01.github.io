...
function parsePLY(data) {
  ...
  if (data instanceof ArrayBuffer) {
    var text = new _textDecoder.default().decode(data);
...
function normalizeAttributes(attributes) {
  var accessors = {}; // mandatory attributes data
  ...
  accessors.position = {
    value: attributes.vertices,
    size: 3
  }; // optional attributes data

  if (attributes.normals.length > 0) {
    accessors.normal = {
      value: attributes.normals,
      size: 3
    };
  }
...
function parseBinary(data, header) {
  ...
  var littleEndian = header.format === 'binary_littleEndian';
