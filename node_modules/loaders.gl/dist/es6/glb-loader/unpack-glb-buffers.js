...
function unpackImages(arrayBuffer, bufferViews, json) {
  ...
  for (let i = 0; i < images.length; ++i) {
    ...
    const array = new Uint8Array(arrayBuffer, bufferView.byteOffset, bufferView.byteLength); // Store the metadata on the array (e.g. needed to determine number of components per element)
