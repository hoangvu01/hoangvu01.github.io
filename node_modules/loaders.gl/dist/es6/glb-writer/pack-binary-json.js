import { flattenToTypedArray } from '../common/loader-utils'; // Recursively packs (replaces) binary objects
...
export default function packBinaryJson(json, glbBuilder, options = {}) {
  ...
  let object = json; // Check if string has same syntax as our "JSON pointers", if so "escape it".
