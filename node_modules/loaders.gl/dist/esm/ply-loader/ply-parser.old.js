...
var SYSTEM_ENDIAN = isLittleEndian ? PLY_FORMAT.BINARY_LITTLE_ENDIAN : PLY_FORMAT.BINARY_BIG_ENDIAN;

var PLYProperty = function PLYProperty(name, data, type, size0, size1) {
  _classCallCheck(this, PLYProperty);
...
var PLYElement = function PLYElement(name, count) {
  _classCallCheck(this, PLYElement);
...
function () {
  function PLYParser() {
    _classCallCheck(this, PLYParser);
  ...
  _createClass(PLYParser, [{
    key: "getline",
    value: function getline(max_len) {
      var ptr = this.offset;
      var cbuf = 0;
      var n = 0;
      var prefix = null;
    ...
    key: "raiseError",
    value: function raiseError(message) {
    ...
    key: "processProperty",
    value: function processProperty(name, type) {
...
export { PLYParser as default };
//# sourceMappingURL=ply-parser.old.js.map