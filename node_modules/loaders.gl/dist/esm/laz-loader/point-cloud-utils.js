...
export function normalize(points) {
  ...
  var scale = Math.max(xMax - xMin, yMax - yMin, zMax - zMin);
  var xMid = (xMin + xMax) / 2;
  var yMid = (yMin + yMax) / 2;
  var zMid = (zMin + zMax) / 2;

  for (var _i = 0; _i < points.length; _i++) {
    points[_i][0] = (points[_i][0] - xMid) / scale;
    points[_i][1] = (points[_i][1] - yMid) / scale;
    points[_i][2] = (points[_i][2] - zMid) / scale;
  }
}
//# sourceMappingURL=point-cloud-utils.js.map